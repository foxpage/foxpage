...
export const clearAll = createAction('WORKSPACE_PROJECTS_PERSONAL_CONTENT__CLEAR_ALL', () => ({}))();

export const updateLoading = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__UPDATE_LOADING',
  (loading: boolean) => ({
    loading,
  }),
)();
...
export const updateSaveLoading = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__UPDATE_SAVE_LOADING',
  (loading: boolean) => ({
    loading,
  }),
)();
...
export const pushLocales = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__FETCH_LOCALES_SUCCESS',
  (locales: string[]) => ({
    locales,
  }),
)();
...
export const updateFileOnlineStatus = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__UPDATE_ONLINE_STATUS',
  (online: boolean) => ({ online }),
)();

// parent file related
export const fetchParentFiles = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__FETCH_PARENT_FILES',
...
export const pushParentFiles = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__PUSH_PARENT_FILES',
...
export const fetchAuthList = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__FETCH_AUTH_LIST',
  (params: AuthorizeListFetchParams) => ({ params }),
)();

export const pushAuthList = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__PUSH_AUTH_LIST',
  (list: AuthorizeListItem[]) => ({ list }),
)();

export const updateAuthListLoading = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__UPDATE_AUTH_LIST_LOADING',
  (status: boolean) => ({
    status,
  }),
)();
...
export const updateAuthDrawerVisible = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__UPDATE_AUTH_DRAWER_VISIBLE',
...
export const saveAuthUser = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__AUTH_ADD_USER',
...
export const deleteAuthUser = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__AUTH_DELETE_USER',
...
export const pushUserList = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_CONTENT__PUSH_USER_LIST',
  (list: User[]) => ({
    list,
  }),
)();
