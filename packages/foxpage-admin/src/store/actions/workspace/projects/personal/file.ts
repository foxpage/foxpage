...
export const clearAll = createAction('WORKSPACE_PROJECTS_PERSONAL_FILE__CLEAR_ALL', () => ({}))();

export const updateLoading = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_FILE__UPDATE_LOADING',
  (loading: boolean) => ({
    loading,
  }),
)();
...
export const updateSaveLoading = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_FILE__UPDATE_SAVE_LOADING',
  (loading: boolean) => ({
    loading,
  }),
)();
...
export const fetchParentFiles = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_FILE__FETCH_PARENT_FILES',
...
export const pushParentFiles = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_FILE__PUSH_PARENT_FILES',
...
export const fetchAuthList = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_FILE__FETCH_AUTH_LIST',
  (params: AuthorizeListFetchParams) => ({ params }),
)();

export const pushAuthList = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_FILE__PUSH_AUTH_LIST',
  (list: AuthorizeListItem[]) => ({ list }),
)();

export const updateAuthListLoading = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_FILE__UPDATE_AUTH_LIST_LOADING',
  (status: boolean) => ({
    status,
  }),
)();
...
export const saveAuthUser = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_FILE__SAVE_AUTH_USER',
...
export const deleteAuthUser = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_FILE__DELETE_AUTH_USER',
...
export const pushUserList = createAction(
  'WORKSPACE_PROJECTS_PERSONAL_FILE__PUSH_USER_LIST',
  (list: User[]) => ({
    list,
  }),
)();
