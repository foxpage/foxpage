...
export const clearAll = createAction('WORKSPACE_PROJECTS_INVOLVED_SEARCH__CLEAR_ALL', () => ({}))();

export const updateLoading = createAction(
  'WORKSPACE_PROJECTS_INVOLVED_SEARCH__UPDATE_LOADING',
  (loading: boolean) => ({
    loading,
  }),
)();
...
export const fetchList = createAction(
  'WORKSPACE_PROJECTS_INVOLVED_SEARCH__FETCH_LIST',
...
export const pushList = createAction(
  'WORKSPACE_PROJECTS_INVOLVED_SEARCH__PUSH_LIST',
