...
export const updateLoading = createAction('ORGANIZATION_TEAM__UPDATE_LOADING', (status: boolean) => ({
  status,
}))();

export const fetchTeamList = createAction(
  'ORGANIZATION_TEAM__FETCH_TEAM_LIST',
  (params: TeamFetchParams) => ({
    ...params,
  }),
)();
...
export const deleteTeam = createAction(
  'ORGANIZATION_TEAM__DELETE_TEAM',
  (organizationId: string, team: Team) => ({
    organizationId,
    team,
  }),
)();
...
export const updateTeam = createAction(
  'ORGANIZATION_TEAM__UPDATE_TEAM',
  (organizationId: string, team: Team) => ({
    organizationId,
    team,
  }),
...
export const addTeamUsers = createAction(
  'ORGANIZATION_TEAM__ADD_TEAM_USERS',
  (params: TeamUsersAddParams) => ({
    ...params,
  }),
)();

export const deleteTeamUsers = createAction(
  'ORGANIZATION_TEAM__DELETE_TEAM_USERS',
  (params: TeamUsersAddParams) => ({
    ...params,
  }),
)();
...
export const fetchTeamUsers = createAction(
  'ORGANIZATION_TEAM__FETCH_TEAM_MEMBERS',
  (params: TeamUsersFetchParams) => ({
    ...params,
  }),
)();

export const pushTeamUsers = createAction(
  'ORGANIZATION_TEAM__PUSH_TEAM_MEMBERS',
  (users: OrganizationUser[]) => ({
    users,
  }),
)();
