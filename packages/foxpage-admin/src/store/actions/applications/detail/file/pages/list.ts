...
export const updateSaveLoading = createAction(
  'APPLICATION_FILE_PAGES_LIST__UPDATE_SAVE_LOADING',
  (loading: boolean) => ({
    loading,
  }),
)();
...
export const openEditDrawer = createAction(
  'APPLICATION_FILE_PAGES_LIST__OPEN_EDIT_DRAWER',
  (drawerOpen = false, editFile?: File) => ({ drawerOpen, editFile }),
)();

export const updateEditFileValue = createAction(
  'APPLICATION_FILE_PAGES_LIST__UPDATE_EDIT_FILE_VALUE',
...
export const fetchAuthList = createAction(
  'APPLICATION_FILE_PAGES_LIST__FETCH_AUTH_LIST',
  (params: AuthorizeListFetchParams) => ({ params }),
)();

export const pushAuthList = createAction(
  'APPLICATION_FILE_PAGES_LIST__PUSH_AUTH_LIST',
...
export const updateAuthDrawerVisible = createAction(
  'APPLICATION_FILE_PAGES_LIST__UPDATE_AUTH_DRAWER_VISIBLE',
...
export const saveAuthUser = createAction(
  'APPLICATION_FILE_PAGES_LIST__SAVE_AUTH_USER',
...
export const deleteAuthUser = createAction(
  'APPLICATION_FILE_PAGES_LIST__DELETE_AUTH_USER',
...
export const pushUserList = createAction('APPLICATION_FILE_PAGES_LIST__PUSH_USER_LIST', (list: User[]) => ({
  list,
}))();
