...
import { RecordFetchEdRes, RecordFetchParams, RecordLog, RecordSaveParams, RecordStatus } from '@/types/index';
...
export const fetchUserRecordStatus = createAction('RECORD__GET_USER_RECORD_STATUS', (params: RecordFetchParams) => ({
  params,
}))();
