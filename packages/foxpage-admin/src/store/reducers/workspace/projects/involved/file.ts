...
export type ProjectInvolvedFileActionType = ActionType<typeof ACTIONS>;
...
const reducer = (state: InitialDataType = initialState, action: ProjectInvolvedFileActionType) =>
  produce(state, (draft) => {
    switch (action.type) {
