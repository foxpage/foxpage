...
import { RemoteComponentItem, RemoteResourceSavedData } from '@/types/application';
import { PaginationInfo } from '@/types/common';

export type PackageFastActionType = ActionType<typeof ACTIONS>;
...
const reducer = (state: StateType = initialData, action: PackageFastActionType) =>
  produce(state, (draft) => {
    switch (action.type) {
