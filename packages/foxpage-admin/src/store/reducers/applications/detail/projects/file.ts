...
export type ApplicationProjectsFileActionType = ActionType<typeof ACTIONS>;
...
const reducer = (state: InitialDataType = initialState, action: ApplicationProjectsFileActionType) =>
  produce(state, (draft) => {
    switch (action.type) {
