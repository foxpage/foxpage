...
export type ApplicationProjectsListActionType = ActionType<typeof ACTIONS>;
...
const reducer = (state: InitialDataType = initialState, action: ApplicationProjectsListActionType) =>
  produce(state, (draft) => {
    switch (action.type) {
