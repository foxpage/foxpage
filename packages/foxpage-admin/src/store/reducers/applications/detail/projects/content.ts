...
export type ApplicationProjectsContentActionType = ActionType<typeof ACTIONS>;
...
const reducer = (state: InitialDataType = initialState, action: ApplicationProjectsContentActionType) =>
  produce(state, (draft) => {
    switch (action.type) {
