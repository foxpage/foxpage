...
const mapStateToProps = (store: RootState) => ({
  loading: store.workspace.projects.personal.search.loading,
  appList: store.workspace.projects.personal.search.appList,
  list: store.workspace.projects.personal.search.list,
  pageInfo: store.workspace.projects.personal.search.pageInfo,
});
