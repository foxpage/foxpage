...
const mapStateToProps = (store: RootState) => ({
  loading: store.workspace.projects.project.detail.loading,
  pageInfo: store.workspace.projects.project.detail.pageInfo,
  fileList: store.workspace.projects.project.detail.fileList,
});
      ...
      render: (text: string, record: ProjectFileType) => {
        return (
          <Link
            ...
            to={`/workspace/project/content?applicationId=${applicationId}&folderId=${folderId}&fileId=${record.id}&fileType=${record.type}&from=workspace`}>
            {text}
          </Link>
        );
      },
