...
import { ApplicationUrlParams, RemoteComponentItem } from '@/types/application';
...
const mapStateToProps = (store: RootState) => ({
  ...
  pageInfo: store.group.application.packages.fast.pageInfo,
  groupId: store.group.application.packages.fast.groupId,
  loading: store.group.application.packages.fast.loading,
      ...
      <Row key={key}>
        <Header
          ...
          <ExpendBtn
            ...
            {expend ? <DownOutlined /> : <UpOutlined />}
          </ExpendBtn>
        </Header>
        {expend && (
          <div>
    ...
    <div>
      <GroupContainer>
        ...
        <GoResource>
          <Link
            to={{
              pathname: `/organization/${organizationId}/application/${applicationId}/detail/resource`,
            }}>
