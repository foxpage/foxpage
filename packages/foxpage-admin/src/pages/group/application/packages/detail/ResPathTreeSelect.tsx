...
import { getResourcesByPathsWithCache, getResourcesGroupSearchsWithCache } from '@/apis/group/application/resource';
...
const ResPathTreeSelect: React.FC<ResPathTreeSelectProps> = ({
  applicationId,
  value,
  disabled,
  onChange = () => {},
