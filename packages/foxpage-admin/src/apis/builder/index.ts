...
import { BuildVersionFetchParams, DslFetchParams } from '@/types/builder/more';
...
export const fetchPageBuildVersion = (params: BuildVersionFetchParams): Promise<ComponentListResponse> =>
  new Promise((resolve) => {
    FoxpageApi.get('/pages/build-versions', params, (rs: ComponentListResponse) => {
      resolve(rs);
    });
  });
export const fetchPageLiveVersion = (params: BuildVersionFetchParams): Promise<ComponentListResponse> =>
  new Promise((resolve) => {
    FoxpageApi.get('/pages/live-version', params, (rs: ComponentListResponse) => {
      resolve(rs);
    });
  });

export const fetchTemplateBuildVersion = (params: BuildVersionFetchParams): Promise<ComponentListResponse> =>
  new Promise((resolve) => {
    FoxpageApi.get('/templates/build-versions', params, (rs: ComponentListResponse) => {
      resolve(rs);
    });
  });
export const fetchTemplateLiveVersion = (params: BuildVersionFetchParams): Promise<ComponentListResponse> =>
  new Promise((resolve) => {
    FoxpageApi.get('/templates/live-version', params, (rs: ComponentListResponse) => {
      resolve(rs);
    });
  });
