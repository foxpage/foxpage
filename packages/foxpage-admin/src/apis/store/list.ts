import { ApplicationStoreGoodsSearchParams } from '@/types/builder';
...
export const fetchStoreProjectResources = (
...
export const fetchStorePackageResources = (
  params: StoreResourceSearchParams,
): Promise<StoreResourceSearchResult> =>
  new Promise((resolve) => {
...
export const fetchStoreVariableResources = (
  params: StoreResourceSearchParams,
): Promise<StoreResourceSearchResult> =>
  new Promise((resolve) => {
...
export const fetchApplicationStoreProjectGoods = (
...
export const fetchApplicationStorePackageGoods = (
  params: ApplicationStoreGoodsSearchParams,
): Promise<ResponseBody> =>
  new Promise((resolve) => {
