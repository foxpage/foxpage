...
export class AppContentLogService extends BaseService<ContentLog> {
  private static _instance: AppContentLogService;

  constructor() {
    super(Model.appContentLog);
  }

  /**
   * Single instance
   * @returns AppContentLogService
   */
  public static getInstance(): AppContentLogService {
    this._instance || (this._instance = new AppContentLogService());
