...
import { UpdateFunctionVersionDetail } from '../../../../src/controllers/functions/update-function-versions';
import { AuthService } from '../../../../src/services/authorization-service';
import { VersionInfoService } from '../../../../src/services/version-services/version-info-service';
import { FoxCtx } from '../../../../src/types/index-types';
import Data from '../../../data';

const varInstance = new UpdateFunctionVersionDetail();
...
let params = {
  ...
  pageContentId: '',
  contentUpdateTime: '',
  content: { id: Data.file.id, schemas: [], relation: {}, extension: {} },
  version: '0.0.2',
};
...
describe('Put: /functions/versions', () => {
