...
import { AddConditionDetail } from '../../../../src/controllers/conditions/add-conditions';
...
const varInstance = new AddConditionDetail();
...
describe('Post: /conditions', () => {
  it('response success', async () => {
    ...
    jest
      ...
      .mockResolvedValueOnce({ code: 0, data: <any>{ id: Data.file.id } });
