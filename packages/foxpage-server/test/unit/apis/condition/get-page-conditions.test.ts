...
import { GetConditionList } from '../../../../src/controllers/conditions/get-page-conditions';
...
const varInstance = new GetConditionList();
...
describe('Get: /condition-searchs', () => {
  ...
  it('response list with different empty folderId', async () => {
    params.type = 'project';
    params.folderId = '';
    jest
      .spyOn(FolderInfoService.prototype, 'getDetailById')
    ...
    jest
      ...
      .mockResolvedValueOnce(Data.folder.list[1].id);
    jest
      .spyOn(FileListService.prototype, 'getFileListByFolderId')
      .mockResolvedValueOnce(<File[]>Data.file.list);
    jest
      .spyOn(FileContentService.prototype, 'getContentByFileIds')
    ...
    jest.spyOn(VersionListService.prototype, 'getVersionListRelations').mockResolvedValueOnce({});
    jest.spyOn(RelationService.prototype, 'formatRelationDetailResponse').mockResolvedValueOnce({});
