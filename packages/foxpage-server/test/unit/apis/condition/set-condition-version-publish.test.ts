...
import { SetConditionVersionPublishStatus } from '../../../../src/controllers/conditions/set-condition-version-publish';
...
const varInstance = new SetConditionVersionPublishStatus();
...
describe('Put: /conditions/version-publish', () => {
