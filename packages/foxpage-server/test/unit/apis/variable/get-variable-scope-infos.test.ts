...
import { GetAppScopeVariableList } from '../../../../src/controllers/variables/get-variable-scope-infos';
...
const varInstance = new GetAppScopeVariableList();
...
describe('Get: /variables/scope-infos', () => {
